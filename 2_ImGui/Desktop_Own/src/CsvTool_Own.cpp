...
void CsvTool::Draw(std::string_view label, bool *open)
{
...
template <typename T>
void CsvTool::PlotCellValue(std::string_view formatter, const T value)
{
...
void CsvTool::DrawValuePopup(const int row, const int col)
{
...
void CsvTool::SaveToCsvFile(std::string_view filename)
{
...
void CsvTool::LoadFromCsvFile(std::string_view filename)
{
...
void CsvTool::SetPopupLayout()
{
    ImGui::SetNextWindowSize(popUpSize);
    ImGui::SetNextWindowPos(popUpPos);
}

void render(CsvTool &window_obj)
{
